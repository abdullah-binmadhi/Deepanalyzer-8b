let
    // =========================================================================
    // INSTRUCTIONS FOR EXCEL POWER QUERY:
    // 1. In Excel, go to: Data tab -> Get Data -> From File -> From Excel Workbook
    // 2. Select your workbook file and choose the "Report" sheet -> Transform Data.
    // 3. In the Power Query window: Home tab -> click "Advanced Editor".
    //    (Make sure you click "Advanced Editor", NOT the single-line Formula Bar fx).
    // 4. Select everything in the editor (Cmd+A on Mac, Ctrl+A on Windows), delete it,
    //    and paste this exact M script below.
    // =========================================================================
    ...
    // 4. Exclude summary grand totals (safe against null separator rows)
